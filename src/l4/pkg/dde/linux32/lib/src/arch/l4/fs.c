...
#if 0 //mask for define at backing-dev.c
struct backing_dev_info default_backing_dev_info = {
	.ra_pages     = MAX_RA_PAGES,
	.state        = 0,
	.capabilities = BDI_CAP_MAP_COPY,
//	.unplug_io_fn = default_unplug_io_fn,       //MMMadd for mask this @26
};
#endif
...
#if 0 //mask for define at page-writeback.c
...
#if 0       //MMMadd mask dde_kern_mount , kern_mount_data
