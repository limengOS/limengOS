...
#define raw_spin_lock_irq(lock)	                _raw_spin_lock(lock)
#define raw_spin_unlock_irq(lock)		        _raw_spin_unlock(lock)
...
#define raw_spin_trylock_irqsave(lock, flags)  spin_trylock_irqsave(lock, flags)
