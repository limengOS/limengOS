...
#ifndef PHYS_OFFSET         /* MMMadd only for build */
...
#else // DDE_LINUX
extern unsigned long __pa(volatile const void *addr);
...
#define virt_to_page(kaddr)	dde_page_lookup((unsigned long)kaddr)
#define virt_addr_valid(kaddr)	(dde_page_lookup((unsigned long)kaddr) != NULL)
#endif
