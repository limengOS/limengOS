...
static void m_ppp(char * p, int l)
{
int i=1;
for(; i <= l ;i++){
    printf("%02x ", *p++);
...
//printf("MMMMMMMMMMMMm==============cpsw_ndo_start_xmit \n");
//m_ppp(skb->data, skb->len);
...
//printf("MMMMMMMMMMMMm==============cpsw_ndo_start_xmit 111:%p ,%d , skb:%p\n", skb->data, skb->len, skb);
