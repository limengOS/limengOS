...
static int __devinit omap_nand_probe(struct platform_device *pdev)
{
	...
	printk(KERN_INFO "Enter omap_nand_probe...........\r\n");
	 ...
	 */
	dev_err(&pdev->dev, "start nand_scan_ident...........\r\n");
	...
	/* second phase scan */
	dev_err(&pdev->dev, "start nand_scan_tail...........\r\n");
	if (nand_scan_tail(&info->mtd)) {
		err = -ENXIO;
		goto out_release_mem_region;
	}

	dev_err(&pdev->dev, "start mtd_device_parse_register(nr_parts=%d)...........\r\n",pdata->nr_parts);
...
//use sync for after omap_elm_init
device_initcall_sync(mtd_omap_nand_init);
