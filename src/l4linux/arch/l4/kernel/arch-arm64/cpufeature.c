...
#ifdef CONFIG_L4
#define kipinfo_case(r, t) \
	case r: return l4lx_kinfo->platform_info.arch.cpuinfo.ID_##t
#endif /* L4 */
...
u64 __read_sysreg_by_encoding(u32 sys_id)
{
	...
	switch (sys_id) {
#ifdef CONFIG_L4
	kipinfo_case(SYS_ID_PFR0_EL1, PFR[0]);
	kipinfo_case(SYS_ID_PFR1_EL1, PFR[1]);
	//kipinfo_case(SYS_ID_PFR2_EL1, PFR[2]);
	kipinfo_case(SYS_ID_DFR0_EL1, DFR0);
	//kipinfo_case(SYS_ID_DFR1_EL1, DFR1);
	//kipinfo_case(SYS_ID_AA64ZFR0_EL1, ...);
	kipinfo_case(SYS_ID_MMFR0_EL1, MMFR[0]);
	kipinfo_case(SYS_ID_MMFR1_EL1, MMFR[1]);
	kipinfo_case(SYS_ID_MMFR2_EL1, MMFR[2]);
	kipinfo_case(SYS_ID_MMFR3_EL1, MMFR[3]);
	//kipinfo_case(SYS_ID_MMFR4_EL1, MMFR[4]);
	//kipinfo_case(SYS_ID_MMFR5_EL1, MMFR[5]);
	kipinfo_case(SYS_ID_ISAR0_EL1, ISAR[0]);
	kipinfo_case(SYS_ID_ISAR1_EL1, ISAR[1]);
	kipinfo_case(SYS_ID_ISAR2_EL1, ISAR[2]);
	kipinfo_case(SYS_ID_ISAR3_EL1, ISAR[3]);
	kipinfo_case(SYS_ID_ISAR4_EL1, ISAR[4]);
	kipinfo_case(SYS_ID_ISAR5_EL1, ISAR[5]);
	kipinfo_case(SYS_MVFR0_EL1, MVFR[0]);
	kipinfo_case(SYS_MVFR1_EL1, MVFR[1]);
	kipinfo_case(SYS_MVFR2_EL1, MVFR[2]);

	kipinfo_case(SYS_ID_AA64PFR0_EL1, AA64PFR[0]);
	kipinfo_case(SYS_ID_AA64PFR1_EL1, AA64PFR[1])
	             & ~(  0xf << ID_AA64PFR1_BT_SHIFT
	                 | 0xf << ID_AA64PFR1_MTE_SHIFT);
	kipinfo_case(SYS_ID_AA64DFR0_EL1, AA64DFR[0]);
	kipinfo_case(SYS_ID_AA64DFR1_EL1, AA64DFR[1]);
	kipinfo_case(SYS_ID_AA64MMFR0_EL1, AA64MMFR[0]);
	kipinfo_case(SYS_ID_AA64MMFR1_EL1, AA64MMFR[1]);
	kipinfo_case(SYS_ID_AA64MMFR2_EL1, AA64MMFR[2]);
	kipinfo_case(SYS_ID_AA64ISAR0_EL1, AA64ISAR[0]);
	kipinfo_case(SYS_ID_AA64ISAR1_EL1, AA64ISAR[1])
		     & ~(  0xf << ID_AA64ISAR1_APA_SHIFT
	                 | 0xf << ID_AA64ISAR1_API_SHIFT
	                 | 0xf << ID_AA64ISAR1_GPA_SHIFT
	                 | 0xf << ID_AA64ISAR1_GPI_SHIFT);
	kipinfo_case(SYS_ID_AA64ISAR2_EL1, AA64ISAR[2]);
#else /* L4 */
