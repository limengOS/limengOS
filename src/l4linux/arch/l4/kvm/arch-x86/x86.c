...
#ifdef CONFIG_L4
		/* There is a problem that causes guest CPU state in (SMBASE +
		 * 0xfe00) - (SMBASE + 0xffff) to get corrupted in L4linux
		 * during emulation of SMM. As a workaround we disable guest SMM
		 * altogether.
		 */
		r = 0;
#endif /* L4 */
