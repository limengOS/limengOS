 ...
 */
#define __put_user_8_asm_wrap(val, addr)				\
({									\
	register const typeof(*(addr)) r0 asm("r0") = val;		\
	register const unsigned long r2 asm("r2") = (unsigned long)addr;\
...
#define put_user(x,ptr)							\
	...
	__chk_user_ptr(ptr);						\
	switch (sizeof(*(ptr))) {					\
	case 1:  __ret_pu = __put_user_1(( u8)((unsigned long)(__typeof__(*(ptr)))(x)),ptr); break; \
	case 2:  __ret_pu = __put_user_2((u16)((unsigned long)(__typeof__(*(ptr)))(x)),ptr); break; \
	case 4:  __ret_pu = __put_user_4((u32)((__typeof__(*(ptr)))(x)),ptr); break; \
	case 8:  __ret_pu = __put_user_8_asm_wrap(((__typeof__(*(ptr)))(x)), ptr); break; \
	default: __ret_pu = __put_user_bad(); break;			\
	}								\
	__ret_pu;							\
	})

#ifndef CONFIG_CPU_SPECTRE
#define __get_user get_user
#endif
...
{
#ifdef CONFIG_L4
	return l4x_copy_to_user(to, from, n);
#else /* L4 */
