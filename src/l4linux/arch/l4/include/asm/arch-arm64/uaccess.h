...
do {									\
	...
	switch (sizeof(*(ptr))) {					\
	case 1:								\
		err = __get_user_1((unsigned char      *)&__gu_val,	\
				   (ptr));				\
		break;							\
	case 2:								\
		err = __get_user_2((unsigned short     *)&__gu_val,	\
				   (ptr));				\
		break;							\
	case 4:								\
		err = __get_user_4((unsigned int       *)&__gu_val,	\
				   (ptr));				\
		break;							\
	case 8:								\
		err = __get_user_8((unsigned long long *)&__gu_val,	\
				   (ptr));				\
		break;							\
	default:							\
		BUILD_BUG();						\
...
do {									\
	...
	switch (sizeof(*(ptr))) {					\
	case 1:								\
		err = __put_user_1((u8)(unsigned long)(__pu_val),	\
				   (ptr));				\
		break;							\
	case 2:								\
		err = __put_user_2((u16)(unsigned long)(__pu_val),	\
				   (ptr));				\
		break;							\
	case 4:								\
		err = __put_user_4((u32)(unsigned long)(__pu_val),	\
				   (ptr));				\
		break;							\
	case 8:								\
		err = __put_user_8((u64)(__pu_val), (ptr));		\
		break;							\
	default:							\
		BUILD_BUG();						\
	}								\
